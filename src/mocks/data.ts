...
export const mockProductionPlans: ProductionPlan[] = [
  ...
  {
    id: 'PLN-2026W16-SUBMIT',
    planName: '2026年第16周主板产测计划（提交预览样例）',
    factory: 'CN',
    week: '2026-W16',
    status: '待确认',
    changeCount: 0,
...
export const mockBurnRows: BurnRow[] = [
  {
    ...
    materialName: 'Q系列|硬件配套|中科H1U板卡|5套生产测试',
    quantity: 400,
    icPartNo: '10200521000002',
    icModel: 'GD32F303VET6',
    programName: 'ECOM_M01_STM32_MCU_T21040101_BOOT_003.hex',
    checksum: 'a1b2c3d4e5f678901234567890abcd01',
    shouldBurn: '是',
    softwarePath: '\\\\192.168.1.30\\firmware\\ASH\\V262B107',
  },
  {
    id: 'BR-2',
    planId: 'PLN-2026W16-001',
    ...
    materialName: '主板|G3A|UMT5 T4(以太网卡)|MCU烧写产测',
    quantity: 200,
    icPartNo: '10200521000012',
    icModel: 'KLM8G3UDU_B04Q(ACE Q100)',
    programName: 'Firmware_G3A_EMMC_T24122407.rar（解压后的烧录）',
    programMatchStatus: 'updated',
    previousProgramName: 'Firmware_G3A_EMMC_T23010101.rar（解压后的烧录）',
    checksum: '7a89211f09a',
    shouldBurn: '是',
    softwarePath: '\\\\192.168.1.30\\firmware\\G3A\\T24122407',
  },
  {
    id: 'BR-3',
    planId: 'PLN-2026W16-001',
    ...
    programName: 'G3A-M01-TC397-MCU-T24091490.hex',
    programMatchStatus: 'updated',
    checksum: '9c2a31ad8ef',
    shouldBurn: '是',
    softwarePath: '\\\\192.168.1.30\\firmware\\G3A\\T24091490',
  },
  {
    id: 'BR-4',
    planId: 'PLN-2026W16-001',
  ...
  },
  {
    ...
    icPartNo: '10200501000004',
    icModel: 'TA10J-SSVDT-AV048 Q100',
    programName: 'Manual_G3A_MCU_T26040101.hex',
    programMatchStatus: 'not_found',
    checksum: 'aabbcc001122',
    shouldBurn: '是',
    softwarePath: '\\\\192.168.1.30\\firmware\\G3A\\manual',
  },
  {
    id: 'BR-6',
    ...
    materialName: '主板|D5X-REVB|标准',
    quantity: 80,
    icPartNo: 'IC-ATX-005',
    icModel: 'EN25QH128A',
    programName: 'ATX-BASE-P4',
    checksum: '77fae9bd042',
    shouldBurn: '否',
    softwarePath: '\\\\192.168.1.30\\firmware\\D5X\\ATX-BASE-P4',
  },
  {
    id: 'BR-7',
    planId: 'PLN-2026W15-002',
    ...
    icPartNo: 'IC-ATX-006',
    icModel: 'W25Q256JV',
    programName: 'ATX-SEC-P4',
    checksum: '11be56f4ac9',
    shouldBurn: '是',
    softwarePath: '\\\\192.168.1.30\\firmware\\D5X\\ATX-SEC-P4',
  },
  {
    id: 'BR-8',
    planId: 'PLN-2026W15-002',
  ...
  },
  {
    ...
    planId: 'PLN-2026W18-004',
    taskNo: 'BM26050102',
    materialCode: '30200999999999',
    materialName: '主板|未知板卡|BOM未维护',
    quantity: 150,
    icPartNo: '',
    icModel: '',
    programName: '',
...
/** 历史计划数据可选年份（Mock：近十年；对接后由库表 DISTINCT year 返回） */
export const mockHistoricalBurnPlanYears: number[] = (() => {
  const currentYear = new Date().getFullYear();
  return Array.from({ length: 10 }, (_, index) => currentYear - index);
})();

/** 产测软件管理：历史板卡烧录计划表（历史计划数据管理）
 *  数据口径：IC料号与 IC型号一一对应（同料号必同型号；同型号可有不同料号） */
export const mockHistoricalBurnPlanRows: HistoricalBurnPlanRow[] = [
  {
    id: 'HBP-W16-1',
    factory: 'CN',
    planDate: '2026-04-14',
  ...
  },
  {
    ...
    icPartNo: '10200501000004',
    icModel: 'TA10J-SSVDT-AV048 Q100',
    programName: 'G3A-M01-TA10J-FPGA-T24080101.bit',
    checksum: '3f8a2c19d04',
    shouldBurn: '是',
    softwarePath: '\\\\192.168.1.30\\firmware\\G3A\\T24080101',
    updatedAt: '2026-04-16 11:20',
  },
  {
    id: 'HBP-W16-5',
    ...
    icPartNo: '10200501000012',
    icModel: 'K4H8B5DTHN-THE1(ACE Q100)',
    programName: 'G3A-M01-DDR4-T24080102.hex',
    checksum: 'e71b4a90c12',
    shouldBurn: '是',
    softwarePath: '\\\\192.168.1.30\\firmware\\G3A\\T24080102',
    updatedAt: '2026-04-16 11:20',
  },
  {
    id: 'HBP-W15-1',
  ...
  },
  {
    ...
    icPartNo: 'IC-ATX-007',
    icModel: 'MX25L12835FMI',
    programName: 'ATX-AUX-P4',
    checksum: '55c3e8a1f20',
    shouldBurn: '否',
    softwarePath: '\\\\192.168.1.30\\firmware\\D5X\\ATX-AUX-P4',
    updatedAt: '2026-04-10 16:35',
  },
  {
    id: 'HBP-W14-1',
    ...
    materialName: '主板|D5X-XSM|通用',
    quantity: 1800,
    icPartNo: '10200521000003',
    icModel: 'STM32F407VGT6',
    programName: 'D5X-XSM-MCU-V240101.hex',
    checksum: '4d2ae78bc10',
    shouldBurn: '是',
    softwarePath: '\\\\192.168.1.30\\firmware\\D5X\\XSM-V240101',
  ...
  },
  {
    ...
    materialName: '主板|D5X-XSM|扩展',
    quantity: 1200,
    icPartNo: '10200811000408',
    icModel: 'GD32F450VGT6',
    programName: 'D5X-XSM-EXT-V240115.hex',
    checksum: '12368263b5h',
    shouldBurn: '是',
    softwarePath: '\\\\192.168.1.30\\firmware\\D5X\\XSM-EXT',
    updatedAt: '2026-04-02 09:00',
  },
  {
    id: 'HBP-VN-W16-1',
  ...
  },
  {
    ...
    icPartNo: '10200521000012',
    icModel: 'KLM8G3UDU_B04Q(ACE Q100)',
    programName: 'Firmware_G3A_EMMC_T23010101.rar（解压后的烧录）',
    checksum: '6b78100e08b',
    shouldBurn: '是',
    softwarePath: '\\\\192.168.1.30\\firmware\\G3A\\T23010101',
    updatedAt: '2024-10-10 14:20',
  },
  {
    id: 'HBP-2024-W40-2',
    factory: 'CN',
    ...
    icPartNo: '10200811000407',
    icModel: 'S3K_TC397Y_256P(805)',
    programName: 'G3A-M01-TC397-MCU-T23080101.hex',
    checksum: '8b1c20be7de',
    shouldBurn: '是',
    softwarePath: '\\\\192.168.1.30\\firmware\\G3A\\T23080101',
    updatedAt: '2024-10-10 14:20',
  },
  {
    id: 'HBP-2023-W30-1',
    ...
    icPartNo: '10200521000003',
    icModel: 'STM32F407VGT6',
    programName: 'D5X-XSM-MCU-V230101.hex',
    checksum: '3c1ae67ab00',
    shouldBurn: '是',
    softwarePath: '\\\\192.168.1.30\\firmware\\D5X\\XSM-V230101',
    updatedAt: '2023-07-28 09:15',
  },
  {
    id: 'HBP-2022-W20-VN-1',
    factory: 'VN',
    planDate: '2022-05-16',
    week: '2022-W20',
    taskNo: 'BM22020129',
    ...
    icPartNo: '10200521000002',
    icModel: 'GD32F303VET6',
    programName: 'ECOM_M01_STM32_MCU_T21040101_BOOT_002.hex',
    checksum: '91a2b3c4d5e678901234567890abcd02',
    shouldBurn: '是',
    softwarePath: '\\\\192.168.1.30\\firmware\\ASH\\V262B106',
    updatedAt: '2022-05-20 11:00',
  },
];
...
export const mockPlanOperationLogs: PlanOperationLog[] = [
  ...
  },
  {
    id: 'LOG-EX-1',
    planId: 'PLN-2026W18-004',
    operatedAt: '2026-04-18 10:15:22',
    operator: '赵六',
    actionType: '创建',
    summary: '创建计划并上传生产计划Excel',
  },
  {
    id: 'LOG-EX-2',
    planId: 'PLN-2026W18-004',
    operatedAt: '2026-04-18 10:18:05',
    operator: '系统',
    actionType: '匹配',
    summary: '匹配完成，存在 BOM 异常行，计划状态置为匹配异常',
  },
  {
    id: 'LOG-2',
    planId: 'PLN-2026W16-001',
